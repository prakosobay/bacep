    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-1">
            <div class="card-header py-3">
                <h4 class="judul text-center"> Finished Permit Colocation</h4>
            </div>
            ...
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    <div class="container-fluid">
                        <div class="card-body">
                            <button class="btn btn-primary btn-sm mx-1 my-2" data-bs-toggle="modal" data-bs-target="#visitorModal">Create Form</button>
                            <a type="button" class="btn btn-sm btn-info mx-1 my-2" href="{{url('isVisitor/{company}/{dept}')}}">Log Form</a>
                            <a type="button" class="btn btn-sm btn-success mx-1 my-2" href="{{ url('finished/{company}/{dept}')}}">Finished Permit</a>
                            <a type="button" class="btn btn-sm btn-secondary mx-1 my-2" href="{{ url('last/form/{company}/{dept}')}}">Last Requested Form</a>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <a class="btn btn-sm btn-success mx-1 my-1" href="{{ url('colo/form')}}">AR CR Form</a>
