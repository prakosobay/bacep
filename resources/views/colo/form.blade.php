...
<div class="container my-5">
    <div class="card">
        ...
        <form action="{{ url('colo/store')}}" method="POST" class="validate-form">
            @csrf
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control" id="req_company" value="{{ auth()->user()->company }}" readonly>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group mb-4">
                            <label for="req_dept" class="form-label">Requestor Department :</label>
                            <input type="text" value="{{ auth()->user()->department }}" id="req_dept" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-group mb-4">
