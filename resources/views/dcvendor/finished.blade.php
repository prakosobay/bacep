        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item mx-5">
                        <a class="nav-link" href="{{ route('dashboardDCVendor' )}}">Log Permit</a>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-1">
            <div class="card-header py-3">
                <h4 class="judul text-center"> Finished Permit </h4>
            </div>
            ...
            <div class="card-body">
                <div class="tab-content" id="myTabContent">
                    <div class="container-fluid">
                        <div class="card-body">
                            <button class="btn btn-primary btn-sm mx-1 my-2" data-bs-toggle="modal" data-bs-target="">Create Form</button>
                            <a type="button" class="btn btn-sm btn-info mx-1 my-2" href="{{ route('dashboardDCVendors')}}">Log Form</a>
                            <a type="button" class="btn btn-sm btn-success mx-1 my-2" href="{{ route('dcvendorFinishedShow')}}">Finished Permit</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <a class="btn btn-sm btn-success mx-1 my-1" href="{{ url('/form')}}">AR CR Form</a>
    ...
    <script>
        $(function() {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('dcvendor/yajra/finished')}}"+'/'+ "",
                columns: [
                    { data: 'work', name: 'work' },
                    { data: 'requestor', name: 'requestor' },
                    { data: 'visit', name: 'visit' },
                    { data: 'leave', name: 'leave' },
                    { data: 'name', name: 'vendor_visitors.name' },
                    { data: 'checkin', name: 'vendor_visitors.checkin' },
                    { data: 'checkout', name: 'vendor_visitors.checkout' },
