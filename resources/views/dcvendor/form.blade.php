                ...
                <div class="row">
                    <div class="col-4 mt-2">
                        ...
                        <div class="form-check mb-2">
                            ...
                            <input type="checkbox" class="form-check-input" id="trafo" name="trafo" value="1">
                        </div>
                    </div>
                    <div class="col-4 mt-2">
                        <div class="form-check mb-2">
                        ...
                        <div class="form-check mb-2">
                            <label for="genset" class="form-check-label">Genset</label>
                            <input type="checkbox" class="form-check-input" id="genset" name="genset" value="1">
                        </div>
                        <div class="form-check mb-2">
                            <label for="battery" class="form-check-label">Battery</label>
                            <input type="checkbox" class="form-check-input" id="battery" name="battery" value="1">
                        </div>
                    ...
                    <div class="col-4 mt-2">
                        <div class="form-check mb-2">
                            ...
                            <input type="checkbox" class="form-check-input" id="ups" name="ups" value="1">
                        </div>
                        <div class="form-check mb-2">
