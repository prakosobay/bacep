...
<div class="container-fluid">
    ...
    <div class="card shadow py-3">
        <h4 class="judul text-center">Full Approval Permit Survey</h4>
        <div class="card-header py-2">
            <a type="button" class="btn btn-success mx-1 my-1" href="{{ route('surveyExportFullApprove')}}">
                Export Excel
            </a>
        </div>
    ...
    <script>
        $(function() {
            $('#internal').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('salesYajraFullApproval')}}',
                columns: [
                    { data: 'id', name: 'id' },
