    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <form method="post" action="{{ route('assetCreateStore') }}" class="validate-form">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('itemcode') is-invalid @enderror"  value="{{ old('itemcode') }}" name="itemcode" required autocomplete="itemcode" id="itemcode" placeholder="itemcode">
                                @error('itemcode')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="satuan" id="satuan" required id="satuan">
