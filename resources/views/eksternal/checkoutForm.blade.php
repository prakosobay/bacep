...
<div class="container my-5">
    <div class="card">
        ...
        <form action="{{ route('eksternalCheckoutUpdate', Crypt::encrypt($getVisitor->id))}}" method="POST" class="validate-form">
            @method('put')
            @csrf
                            ...
                            <tr>
                                <th colspan="4" class="py-5">
                                    <div class="form-group">
                                        ...
                                        <img src="{{ url('storage/eksternal/checkin/'.$getVisitor->photo_checkin) }}" alt="" width="400px">
                                    </div>
                                    <div class="form-group">
