        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item mx-5">
                        <a class="nav-link" href="{{ route('dashboardEksternal', auth()->user()->company )}}">Log Permit</a>
                    </li>
                </ul>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <a class="btn btn-sm btn-success mx-1 my-1" href="{{ route('eksternalShowForm')}}">AR CR Form</a>
                                    {{-- <a class="btn btn-sm btn-success mx-1 my-1" href="{{ route('order/form')}}">Consumable Form</a>
                                    <a class="btn btn-sm btn-success mx-1 my-1" href="{{ route('eksternal/formBarang')}}">AR CR + Barang Form</a>
                                    <a class="btn btn-sm btn-success mx-1 my-1" href="{{ route('eksternal/formConsumableBarang')}}">AR CR + Consumable + Barang Form</a> --}}
                                </div>
    ...
    {{-- <script>
        $(function() {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ url('eksternal/yajra/show')}}"+'/'+ "{{auth()->user()->company}}",
                columns: [
