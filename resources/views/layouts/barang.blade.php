...
<body id="body-pd">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#asset_collapse"
                    aria-expanded="true" aria-controls="asset_collapse">
                ...
                <div id="asset_collapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('assetTable')}}">Asset Table</a>
                        <a class="collapse-item" href="{{ route('assetMasukShow')}}">Asset Masuk</a>
                        <a class="collapse-item" href="{{ route('assetKeluarShow')}}">Asset Keluar</a>
                        <a class="collapse-item" href="{{ route('assetDigunakanShow')}}">Asset Digunakan</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#consum_collapse"
                    aria-expanded="true" aria-controls="consum_collapse">
                    <i class="fas fa-fw fa-cog"></i>
            ...
            <li class="nav-item">
                ...
                <div id="access_card" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="#">New Employees</a>
