            ...
            <div class="container form-container">
                ...
                <div class="row">
                    <div class="col-4 mt-2">
                        <div class="form-check mb-3">
                            ...
                            <input type="checkbox" class="form-check-input" id="dc" name="dc" value="{{ old('dc')}}" >
                        </div>
                        <div class="form-check mb-5">
                            <label for="mmr1" class="form-check-label">MMR 1</label>
                            <input type="checkbox" class="form-check-input" id="mmr1" name="mmr1" value="{{ old('mmr1')}}}">
                        </div>
                    </div>
                    <div class="col-4 mt-2">
                        <div class="form-check mb-3">
                            <label for="mmr2" class="form-check-label">MMR 2</label>
                            <input type="checkbox" class="form-check-input" id="mmr2" name="mmr2" value="{{ old('mmr2')}}}">
                        </div>
                        <div class="form-check mb-5">
                            <label for="cctv" class="form-check-label">CCTV Room</label>
                            <input type="checkbox" class="form-check-input" id="cctv" name="cctv" value="{{ old('cctv')}}}">
                        </div>
                    </div>
                    <div class="col-4 mt-2">
                        <div class="form-check mb-3">
                ...
                {{-- <table class="table table-bordered table-hover mb-5">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <input type="time" class="form-control @error('time_start') is-invalid @enderror" id="detailTime" name="time_start[]" value="{{ old('time_start')}}" required>
                                @error('time_start')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <td>
                                <input type="time" class="form-control @error('time_end') is-invalid @enderror" id="detailTime" name="time_end[]" value="{{ old('time_end')}}" required>
                                @error('time_end')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <td>
                                <input type="text" class="form-control @error('activity') is-invalid @enderror" id="detailTime" name="activity[]" value="{{ old('activity')}}" required>
                                @error('activity')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <td>
                                <input type="text" class="form-control @error('service_impact') is-invalid @enderror" id="detailTime" name="service_impact[]" value="{{ old('service_impact')}}" required>
