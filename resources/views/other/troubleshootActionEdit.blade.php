...
{{-- modal Reject --}}
<div class="modal fade" id="rejectTroubleshoot" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('other/troubleshoot/full/reject', $model->id)}}" method="POST">
                @csrf
