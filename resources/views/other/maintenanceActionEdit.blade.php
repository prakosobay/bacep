...
<button type="button" class="btn btn-danger btn-sm mx-2 my-2" data-bs-toggle="modal" data-bs-target="#reject_maintenance">
    Reject
</button>

{{-- modal Reject --}}
<div class="modal fade" id="reject_maintenance" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
