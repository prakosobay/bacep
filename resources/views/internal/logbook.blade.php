            ...
            <table class="table table-detail">
                ...
                @foreach ( $internals as $p )
                    <tr>
                        ...
                        <td class="table-center">{{ $p->internal->work }}</td>
                        <td class="table-center">{{ $p->internal->requestor->name }}</td>
                        <td class="table-center">{{ $p->internal->visit }}</td>
                        <td class="table-center">{{ $p->internal->leave }}</td>
                        ...
                        <td class="table-center">
                            <img src="{{ public_path('storage/internal/checkin/'.$p->photo_checkin) }}" width="180px" height="180px">
                        </td>
                        <td class="table-center">{{ $p->checkout }}</td>
                        <td class="table-center">
                            <img src="{{ public_path('storage/internal/checkout/'.$p->photo_checkout) }}" width="180px" height="180px">
                        </td>
                    </tr>
                @endforeach
            </table>
