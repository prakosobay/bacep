...
class CreateFormCleaningsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_cleanings', function (Blueprint $table) {
            $table->bigIncrements('form_c_id')->unique();
    ...
    {
        Schema::dropIfExists('form_cleanings');
    }
}
