...
class CreateRutinsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rutin', function (Blueprint $table) {
            ...
            $table->string('loc2')->nullable();
            $table->string('loc3')->nullable();
            $table->string('loc4')->nullable();
            $table->string('loc5')->nullable();
            $table->string('loc6')->nullable();
            $table->string('loc7')->nullable();
            $table->string('loc8')->nullable();
            $table->string('loc9')->nullable();
            $table->string('loc10')->nullable();
            $table->string('loc11')->nullable();
            $table->string('loc12')->nullable();
            $table->string('loc13')->nullable();
            $table->string('loc14')->nullable();
